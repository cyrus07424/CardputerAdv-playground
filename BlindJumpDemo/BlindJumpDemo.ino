...
inline int play_height() { return display_height() - HUD_H - FOOTER_H; }
inline int room_cols() { return display_width() / TILE_SIZE; }
inline int room_rows() { return play_height() / TILE_SIZE; }
#define PLAY_H play_height()
#define ROOM_COLS room_cols()
#define ROOM_ROWS room_rows()
