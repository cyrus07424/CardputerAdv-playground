...
- Data Harvester では **Text / Satellites / Signal / Compass / Speed** の表示モードを切り替え可能
...
6. Data Harvester では BtnA または左右カーソルキーで表示モードを切り替え、Text 画面と Signal 画面では上下カーソルキーで表示内容をスクロールし、Fn キーで LoRa 受信ビープ音の ON/OFF を切り替える
